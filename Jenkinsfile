pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'CLION_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-clion'
    CONTAINER_NAME = 'clion'
    DOCKERHUB_IMAGE = 'linuxserver/clion'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/clion'
    PR_DOCKERHUB_IMAGE = 'lspipepr/clion'
    DIST_IMAGE = 'arch'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
  ...
  stages {
    ...
    stage("Set tag custom bash"){
      steps{
        script{
          env.EXT_RELEASE = sh(
            script: ''' curl -sL https://mirror.rackspace.com/archlinux/extra/os/x86_64/extra.db | tar tzf - | awk -F '(-|/)' '/clion-community-edition/ {print $5; exit}' ''',
            returnStdout: true).trim()
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-clion/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-clion\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-clion\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Intellij-idea\" \
          --label \"org.opencontainers.image.description=[IntelliJ IDEA](https://www.jetbrains.com/idea/) helps you write code faster with tools that eliminate tedious tasks and let you focus on what matters – building great software.\" \
