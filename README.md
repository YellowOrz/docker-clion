...
- This project is almost entirely copied from https://github.com/linuxserver/docker-intellij-idea
...
<!-- Please read https://github.com/linuxserver/docker-clion/blob/master/.github/CONTRIBUTING.md -->
...
# [linuxserver/clion](https://github.com/linuxserver/docker-clion)

[![Scarf.io pulls](https://scarf.sh/installs-badge/linuxserver-ci/linuxserver%2Fclion?color=94398d&label-color=555555&logo-color=ffffff&style=for-the-badge&package-type=docker)](https://scarf.sh)
[![GitHub Stars](https://img.shields.io/github/stars/linuxserver/docker-clion.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-clion)
[![GitHub Release](https://img.shields.io/github/release/linuxserver/docker-clion.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/linuxserver/docker-clion/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/linuxserver/docker-clion/packages)
[![GitLab Container Registry](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitLab%20Registry&logo=gitlab)](https://gitlab.com/linuxserver.io/docker-clion/container_registry)
[![Quay.io](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=Quay.io)](https://quay.io/repository/linuxserver.io/clion)
[![Docker Pulls](https://img.shields.io/docker/pulls/linuxserver/clion.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=pulls&logo=docker)](https://hub.docker.com/r/linuxserver/clion)
[![Docker Stars](https://img.shields.io/docker/stars/linuxserver/clion.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=stars&logo=docker)](https://hub.docker.com/r/linuxserver/clion)
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-clion%2Fjob%2Fmaster%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-clion/job/master/)
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fclion%2Flatest%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/clion/latest/index.html)

[CLion](https://www.jetbrains.com/clion/) is a powerful IDE for C and C++ from JetBrains, offering intelligent code assistance, smart code navigation, reliable refactorings, and on-the-fly code analysis with quick-fixes.

[![clion](https://upload.wikimedia.org/wikipedia/commons/6/62/Clion.svg)](https://www.jetbrains.com/clion/)

## Supported Architectures

We utilise the docker manifest for multi-platform awareness. More information is available from docker [here](https://distribution.github.io/distribution/spec/manifest-v2-2/#manifest-list) and our announcement [here](https://blog.linuxserver.io/2019/02/21/the-lsio-pipeline-project/).

Simply pulling `lscr.io/linuxserver/clion:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  clion:
    image: lscr.io/linuxserver/clion:latest
    environment:
      - PIXELFLUX_WAYLAND=true
...
docker run -d \
  ...
  --shm-size="1gb" \
  --restart unless-stopped \
  lscr.io/linuxserver/clion:latest
```
...
| Parameter | Function |
| :----: | --- |
| `-p 3000:3000` | CLion desktop gui HTTP must be proxied. |
| `-p 3001:3001` | CLion desktop gui HTTPS. |
...
[![Docker Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=clion&query=%24.mods%5B%27clion%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/?mod=clion "view available mods for this container.") [![Docker Universal Mods](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=universal&query=%24.mods%5B%27universal%27%5D.mod_count&url=https%3A%2F%2Fraw.githubusercontent.com%2Flinuxserver%2Fdocker-mods%2Fmaster%2Fmod-list.yml)](https://mods.linuxserver.io/mod=universal "view available universal mods.")
...
* Container version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' clion
    ```

* Image version number:

    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/clion:latest
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/clion:latest
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/clion:latest .
```
